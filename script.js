...
const offerings = [
  ...
  {name:"Values-Based Stories",icon:"storytelling.png",text:"A platform to bring together established and upcoming, like-hearted individuals from the fraternity to collaborate on meaningful plays, films and performances which are rooted in strong values to encourage positivity and a deeper sense of purpose in the audience. We present stories which awaken hearts, inspire friendships and nurtures a better more compassionate and values-driven society."},
